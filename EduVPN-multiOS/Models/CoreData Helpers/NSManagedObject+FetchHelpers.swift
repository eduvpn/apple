...
extension NSFetchRequestResult where Self: NSManagedObject {
     ...
     */
    public static func findFirstInContext(_ context: NSManagedObjectContext,
     ...
     */
    public static func allInContext(_ context: NSManagedObjectContext,
    ...
    // MARK: Private Funcs
    private static func removeAllObjectsReturnedByRequest(_ fetchRequest: NSFetchRequest<Self>,
